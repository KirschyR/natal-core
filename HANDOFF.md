...
> **⚠️ 本文档是 P0–P1 时代的任务书，部分内容已过时。** 当前进度、已完成/未完成清单、P7 规划与接手入口
> 以 [`GPU_STAGE_SUMMARY.md`](./GPU_STAGE_SUMMARY.md) **§11（§11.1 已完成 / §11.2 计划表 / §11.5 P7 / §11.6 快照）** 为准；
> 审查记录在 [`EVALUATE.md`](./EVALUATE.md)（附录 A 有全局交接快照）。
