...
> **当前状态（2026-09-21，上下文切换）**：本文档是**冻结的设计与 D1–D7 决定**；实施进度、已完成/未完成
> 清单与下一项以 [`GPU_STAGE_SUMMARY.md`](./GPU_STAGE_SUMMARY.md) **§11** 为准（本文件中的 Phase 顺序在
> 实施中已纠正）。其中「不移植 CSR 钩子解释器」已由 §11.5 的 **P7（设备侧声明式钩子）** 修订为分层策略。
